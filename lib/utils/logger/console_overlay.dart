...
class _ConsoleOverlayWidgetState extends State<ConsoleOverlayWidget> {
  ...
  Widget _buildDragView(BoxConstraints constraints) {
    return Container(
      ...
      key: _globalForDrag,
      height: _isLarge ? constraints.maxHeight + _mangerSize : _logHeigh + _mangerSize,
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            TextStyle _logStyle = TextStyle(color: ConsoleUtil.getLevelColor(logMode.level), fontSize: 15, decoration: TextDecoration.none, fontWeight: FontWeight.w400);
  ...
  final List<String> _logLevelFilter = ["all", "verbose", "debug", "info", "warn", "error", "取消"];
